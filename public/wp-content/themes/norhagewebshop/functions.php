...
function norhagewebshop_create_posttypes() {
 	...
 	$contentTypes = [
 		'greenhouse'	=> [
 			...
 			'labels'	=> [
				...
				'add_new' 					=> __( 'New greenhouse', 'norhagewebshop' ),
				'add_new_item' 				=> __( 'Add new greenhouse', 'norhagewebshop' ),
				'edit_item' 				=> __( 'Edit greenhouse', 'norhagewebshop' ),
				'new_item'					=> __( 'New greenhouse', 'norhagewebshop' ),
				'view_item' 				=> __( 'View greenhouse', 'norhagewebshop' ),
				'search_items'				=> __( 'Search greenhouse', 'norhagewebshop' ),
				'not_found' 				=>  __( 'No greenhouses found', 'norhagewebshop' ),
				'not_found_in_trash' 		=> __( 'No greenhouses found in trash', 'norhagewebshop'),
			]
		],
 		'plastic'	=> [
 			'slug'		=> 'plastic',
 			...
 			'labels'	=> [
				'name' 						=> __( 'Plastics', 'norhagewebshop' ),
				'singular_name' 			=> __( 'Plastic', 'norhagewebshop' ),
				'add_new' 					=> __( 'New plastic', 'norhagewebshop' ),
				'add_new_item' 				=> __( 'Add new plastic', 'norhagewebshop' ),
				'edit_item' 				=> __( 'Edit plastic', 'norhagewebshop' ),
				'new_item'					=> __( 'New plastic', 'norhagewebshop' ),
				'view_item' 				=> __( 'View plastics', 'norhagewebshop' ),
				'search_items'				=> __( 'Search plastics', 'norhagewebshop' ),
				'not_found' 				=>  __( 'No plastics found', 'norhagewebshop' ),
				'not_found_in_trash' 		=> __( 'No plastics found in trash', 'norhagewebshop'),
			]
		],
 		'service'	=> [
 			'slug'		=> 'service',
 			...
 			'labels'	=> [
				'name' 						=> __( 'Services', 'norhagewebshop' ),
				'singular_name' 			=> __( 'Service', 'norhagewebshop' ),
				'add_new' 					=> __( 'New service', 'norhagewebshop' ),
				'add_new_item' 				=> __( 'Add new service', 'norhagewebshop' ),
				'edit_item' 				=> __( 'Edit service', 'norhagewebshop' ),
				'new_item'					=> __( 'New service', 'norhagewebshop' ),
				'view_item' 				=> __( 'View service', 'norhagewebshop' ),
				'search_items'				=> __( 'Search services', 'norhagewebshop' ),
				'not_found' 				=>  __( 'No services found', 'norhagewebshop' ),
				'not_found_in_trash' 		=> __( 'No services found in trash', 'norhagewebshop'),
			]
		],
 		'construction'	=> [
 			'slug'		=> 'construction',
 			...
 			'labels'	=> [
				'name' 						=> __( 'Construction materials', 'norhagewebshop' ),
				'singular_name' 			=> __( 'Construction material', 'norhagewebshop' ),
				'add_new' 					=> __( 'New construction material', 'norhagewebshop' ),
				'add_new_item' 				=> __( 'Add new construction material', 'norhagewebshop' ),
				'edit_item' 				=> __( 'Edit construction material', 'norhagewebshop' ),
				'new_item'					=> __( 'New construction material', 'norhagewebshop' ),
				'view_item' 				=> __( 'View construction material', 'norhagewebshop' ),
				'search_items'				=> __( 'Search construction materials', 'norhagewebshop' ),
				'not_found' 				=>  __( 'No construction materials found', 'norhagewebshop' ),
				'not_found_in_trash' 		=> __( 'No construction materials found in trash', 'norhagewebshop'),
			]
		]
	];
	...
	$defaultPostSettings = [
		...
		'template'				=> [
			[
				'norhagewebshop/product-header-block',
				[
					'lock'		=> [
						'move'		=> true,
						'remove'	=> true
			...
			[
				'core/heading',
				[
					'placeholder'	=> __('You should know that', 'norhagewebshop'),
					'lock'		=> [
						'move'		=> true,
						'remove'	=> true
					]
			...
			[
				'norhagewebshop/text-image-block',
				[
					'lock'		=> [
						'move'		=> false,
						'remove'	=> false
