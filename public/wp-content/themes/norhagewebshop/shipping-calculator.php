...
<form class="norhage-shipping-calculator" action="<?php echo admin_url('admin-ajax.php'); ?>?action=calc_shipping_costs" method="post">

	<?php printf( '<a href="#" class="norhage-shipping-calculator-button">%s</a>', esc_html( ! empty( $button_text ) ? $button_text : __( 'Calculate shipping', 'woocommerce' ) ) ); ?>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php wp_nonce_field( 'calc_shipping_costs', 'norhage-calc-shipping-costs' ); ?>
	</section>
</form>
